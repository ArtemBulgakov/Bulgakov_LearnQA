...
public class HelloWordTest {
    ...
    public void testRestAssured() throws InterruptedException {
        ...
        String[][] twoDimArray = {{"password", "password", "123456", "123456", "123456", "123456", "123456", "123456", "123456"},
        ...
        Response response1;
        String passwordYes = twoDimArray[0][0];
        ...
        for (int i = 0; i < twoDimArray.length; i++) {
            for (int j = 0; j < twoDimArray[0].length; j++) {
                ...
                data.put("password", twoDimArray[i][j]);
                ...
                if (response2.asString().equals("You are authorized")) {
                    passwordYes = twoDimArray[i][j];
                    break;
                }

            }
            if (response2.asString().equals("You are authorized")) {
                System.out.println("access password - " + passwordYes);
                System.out.print("message at second response - ");
                response2.print();
                break;
            }
        }
